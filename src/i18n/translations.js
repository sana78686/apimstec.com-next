...
export const translations = {
  en: {
    ...
    corporate: {
      ...
      homeHeroTitle: 'Technology help for real businesses',
      homeHeroSubtitle:
        'We are an IT company. We build software, mobile apps, and online tools, and we explain everything in words you already know.',
      ...
      ctaPlatform: 'Explore services',
      featuresHeading: 'What we deliver',
      feature1Title: 'Services',
      feature1Body:
        'AI help, custom software, apps for phones and browsers, and support when your data needs sorting.',
      feature2Title: 'Hosting & deploy',
      feature2Body:
        'Web, cloud, VPS, and WordPress hosting—with Plesk as your control panel on every plan.',
      feature3Title: 'Solutions',
      feature3Body:
        'Apps, games, custom software, digital marketing, and e-commerce—pick what you need now and grow later.',
    ...
    title: 'Apimstec — IT services, software, and apps',
    /** Home `<title>`, Open Graph, and landing `<h1>`. */
    seoHeroH1: 'Apimstec — IT services, software, and apps',
    subtitle: 'We design and build digital products for teams that want straight answers and steady delivery.',
    ...
    footerBlog: 'Blog',
    footerTagline: 'Software, apps, and IT support explained in plain language.',
    ...
    footerAddressPlaceholder: 'Zakriya Town, Multan, Pakistan',
    ...
    contact: {
      ...
      errorBothNames: 'Please enter both first name and last name.',
