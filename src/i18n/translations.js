...
export const translations = {
  en: {
    ...
    corporate: {
      homeEyebrow: 'Shaping smarter technology',
      homeHeroTitle: 'AI-enabled ecosystems that make business simpler',
      homeHeroSubtitle:
        'We remove complexity from the technology lifecycle with a composable platform and trusted domain expertise.',
      contentSoon: 'This page is ready for your content. Add copy and media in the CMS or update this route when your pages are ready.',
      cmsSectionLabel: 'Featured content from CMS',
      comingSoonTitle: 'Coming soon',
      comingSoonDesc: 'This section is not available yet. Return to the home page to explore the site.',
      ...
      ctaPlatform: 'Explore platform',
      featuresHeading: 'What we deliver',
      feature1Title: 'Composable platform',
      feature1Body:
        'Integrate digital retail, finance workflows, and servicing with a unified, API-first architecture.',
      feature2Title: 'Expert consultancy',
      feature2Body:
        'Lifecycle guidance for regulated industries—from strategy through implementation and adoption.',
      feature3Title: 'Industry solutions',
      feature3Body:
        'Purpose-built paths for lenders, OEMs, dealers, and enterprises scaling with confidence.',
      featureCta: 'Learn more',
      homeCardsTitle: 'What we offer',
      faqSectionTitle: 'Featured articles',
    },
    insights: {
      searchKeywords: 'Search by keywords',
      searchPlaceholder: 'Search articles…',
      filterByType: 'Quick links',
      showMore: 'Show more',
      pillLabel: 'Article',
      sidebarLabel: 'Insights filters',
    },
    title: 'Apimstec — digital solutions & platform engineering',
    /** Home `<title>`, Open Graph, and landing `<h1>`. */
    seoHeroH1: 'Apimstec — digital solutions & platform engineering',
    subtitle: 'We build reliable platforms, integrations, and digital products for growing businesses.',
    ...
    footerBlog: 'Blog',
    footerTagline: 'Composable platforms and trusted expertise for regulated industries.',
    footerConnect: 'Connect with us',
    footerWhyApimsTec: 'Why ApimsTec',
    footerInvestors: 'Investors',
    footerCompanyInfo: 'Company information',
    footerSectionProducts: 'Products',
    footerSectionMarketplace: 'Marketplace',
    footerSectionConsultancy: 'Consultancy',
    footerSectionInsights: 'Insights',
    footerSectionSolutions: 'Solutions',
    footerCaseStudies: 'Case studies',
    footerGuides: 'Guides',
    footerEvents: 'Events',
    footerSolutionAuto: 'Automotive finance',
    footerSolutionEquipment: 'Equipment finance',
    footerSolutionBanking: 'Asset finance',
    footerHeadquarters: 'Corporate headquarters',
    footerAddressPlaceholder: 'Contact us for regional office locations.',
    footerHumanRights: 'Human rights policy',
    footerModernSlavery: 'Modern slavery act',
    footerCopyright: '© ApimsTec 2026. All rights reserved.',
    footerOther: 'OTHER',
    footerCopyrightPrefix: '© Apimstec 2026 – ',
    ...
    contact: {
      ...
      intro: 'Use the form below to reach our team. We aim to respond to every message as soon as we can.',
      detailsHeading: 'Contact details',
      sendAnother: 'Send another message',
      email: 'Email',
      supportInbox: 'Support inbox',
      officeEmail: 'Office email',
      emailNote: 'Form submissions are delivered to our support inbox.',
      phone: 'Phone',
      address: 'Address',
      backHome: 'Back to home',
    ...
    blog: {
      ...
      emptyBody:
        'No posts yet. We will publish articles on engineering, product updates, and client work here.',
      backHome: 'Back to home',
...
/** Apimstec marketing site: English only in URL (no /en or /id prefix). */
